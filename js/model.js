...
export const SPECIES = [
  { id: 'cory',    n: 'Corydora (albina/aeneus)', sci: 'Corydoras aeneus', adult: 6.5, zona: 'fundo', bio: 1.0, grupo: 6, temp: [22, 26], ph: [6.0, 7.8], camarao: 'medio', planta: 'baixo', betta: 'ok', kind: 'fish', color: '#c9a876',
    obs: 'Fundo, pacífica, precisa de grupo e substrato liso. Ração que afunde, de preferência à noite.' },
  { id: 'neon',    n: 'Neon-tetra', sci: 'Paracheirodon innesi', adult: 3.5, zona: 'meia-água', bio: 0.5, grupo: 8, temp: [22, 26], ph: [5.5, 7.5], camarao: 'medio', planta: 'baixo', betta: 'atencao', kind: 'fish', color: '#3fa9f5',
    obs: 'Cardume grande reduz estresse. Cor viva pode atrair investida do Betta em espaço apertado.' },
  { id: 'betta',   n: 'Betta macho', sci: 'Betta splendens', adult: 6.5, zona: 'superfície', bio: 1.2, grupo: 1, temp: [24, 28], ph: [6.0, 7.5], camarao: 'alto', planta: 'baixo', betta: 'self', kind: 'fish', color: '#e0392b',
    obs: 'Fluxo brando, tampa fechada, sem rebarbas. Último a entrar no comunitário.' },
  { id: 'neritina', n: 'Neritina', sci: 'Neritina natalensis', adult: 2.5, zona: 'vidros', bio: 0.3, grupo: 1, temp: [22, 28], ph: [7.0, 8.2], camarao: 'baixo', planta: 'baixo', betta: 'ok', kind: 'snail', color: '#8a6d3b',
    obs: 'Come biofilme e algas. Só em aquário maduro, com alimento natural disponível.' },
  { id: 'redcherry', n: 'Camarão Red Cherry', sci: 'Neocaridina davidi', adult: 2.5, zona: 'fundo', bio: 0.15, grupo: 6, temp: [20, 27], ph: [6.5, 7.8], camarao: 'self', planta: 'baixo', betta: 'risco', kind: 'shrimp', color: '#ef5b6f',
    obs: 'Filhotes são presa fácil. Precisa de muitos esconderijos e musgo.' },
  { id: 'otocinclus', n: 'Otocinclus', sci: 'Otocinclus sp.', adult: 4, zona: 'vidros', bio: 0.5, grupo: 4, temp: [22, 26], ph: [6.0, 7.5], camarao: 'baixo', planta: 'baixo', betta: 'ok', kind: 'fish', color: '#8a8a78',
    obs: 'Sensível: só em aquário maduro com algas/biofilme e alimentação suplementar.' },
  { id: 'platy',   n: 'Platy', sci: 'Xiphophorus maculatus', adult: 5, zona: 'meia-água', bio: 0.9, grupo: 3, temp: [22, 27], ph: [7.0, 8.2], camarao: 'medio', planta: 'baixo', betta: 'atencao', kind: 'fish', color: '#f2924a', obs: 'Reproduz muito; a carga cresce sozinha.' },
  { id: 'guppy',   n: 'Guppy', sci: 'Poecilia reticulata', adult: 4, zona: 'superfície', bio: 0.7, grupo: 3, temp: [22, 28], ph: [7.0, 8.2], camarao: 'medio', planta: 'baixo', betta: 'risco', kind: 'fish', color: '#f2c14e', obs: 'Cauda colorida costuma provocar o Betta.' },
  { id: 'rasbora', n: 'Rasbora-arlequim', sci: 'Trigonostigma heteromorpha', adult: 4, zona: 'meia-água', bio: 0.6, grupo: 8, temp: [23, 27], ph: [6.0, 7.5], camarao: 'baixo', planta: 'baixo', betta: 'ok', kind: 'fish', color: '#d98a4a', obs: 'Boa companhia para Betta: discreta e de cardume.' },
  { id: 'kuhli',   n: 'Botia-palhaço/Kuhli', sci: 'Pangio kuhlii', adult: 8, zona: 'fundo', bio: 0.8, grupo: 4, temp: [24, 28], ph: [6.0, 7.5], camarao: 'medio', planta: 'baixo', betta: 'ok', kind: 'fish', color: '#d4a017', obs: 'Precisa de substrato macio e esconderijos.' },
  { id: 'danio',   n: 'Danio-zebra', sci: 'Danio rerio', adult: 5, zona: 'meia-água', bio: 0.6, grupo: 6, temp: [18, 24], ph: [6.5, 7.5], camarao: 'baixo', planta: 'baixo', betta: 'atencao', kind: 'fish', color: '#4a90d9',
    obs: 'Muito ativo e resistente a oscilações — bom para aquário recém-montado. Prefere água um pouco mais fresca que o comunitário tropical padrão; nadadeira longa do Betta pode atrair bicadas.' },
  { id: 'molinesia', n: 'Molinésia', sci: 'Poecilia sphenops', adult: 8, zona: 'meia-água', bio: 1.0, grupo: 3, temp: [24, 28], ph: [7.0, 8.5], camarao: 'medio', planta: 'medio', betta: 'atencao', kind: 'fish', color: '#3a3a3d',
    obs: 'Prefere água mais dura e alcalina que tetras — confira o pH antes de introduzir. Reproduz com facilidade; a população cresce sozinha.' },
  { id: 'cherrybarb', n: 'Barbo-cereja', sci: 'Pethia nigrofasciata', adult: 5, zona: 'meia-água', bio: 0.6, grupo: 6, temp: [22, 26], ph: [6.0, 7.5], camarao: 'baixo', planta: 'baixo', betta: 'atencao', kind: 'fish', color: '#d94f6a',
    obs: 'Pacífico em cardume grande; em grupo pequeno os machos disputam território entre si.' },
  { id: 'lemontetra', n: 'Tetra-limão', sci: 'Hyphessobrycon pulchripinnis', adult: 4.5, zona: 'meia-água', bio: 0.5, grupo: 8, temp: [23, 27], ph: [6.0, 7.0], camarao: 'medio', planta: 'baixo', betta: 'atencao', kind: 'fish', color: '#f2e024',
    obs: 'Cardume grande realça a cor amarela. Sensível a água velha — TPAs regulares mantêm a cor viva.' },
  { id: 'cardinal', n: 'Tetra-cardinal', sci: 'Paracheirodon axelrodi', adult: 4, zona: 'meia-água', bio: 0.5, grupo: 8, temp: [24, 28], ph: [5.0, 6.5], camarao: 'medio', planta: 'baixo', betta: 'atencao', kind: 'fish', color: '#e2483a',
    obs: 'Parecido com o Neon-tetra, mas exige água mais quente e ácida; mais sensível a oscilações de qualidade que o Neon.' },
  { id: 'gourami', n: 'Gourami-anão', sci: 'Trichogaster lalius', adult: 8, zona: 'superfície', bio: 1.1, grupo: 1, temp: [24, 28], ph: [6.0, 7.5], camarao: 'medio', planta: 'baixo', betta: 'risco', kind: 'fish', color: '#e05a9b',
    obs: 'Respira ar atmosférico na superfície — não tampe totalmente a saída de ar. Territorialista com o próprio macho e com o Betta, ambos de superfície.' },
  { id: 'angelfish', n: 'Acará-bandeira', sci: 'Pterophyllum scalare', adult: 15, zona: 'meia-água', bio: 2.2, grupo: 1, temp: [24, 28], ph: [6.0, 7.5], camarao: 'alto', planta: 'baixo', betta: 'risco', kind: 'fish', color: '#c7ccd1',
    obs: 'Cresce grande e territorialista quando adulto — evite com Neon, Guppy pequenos e camarões, pode predar. Exige aquário mais alto e maior que 80 L.' },
  { id: 'amano',   n: 'Camarão Amano', sci: 'Caridina multidentata', adult: 5, zona: 'fundo', bio: 0.2, grupo: 6, temp: [20, 27], ph: [6.5, 7.5], camarao: 'self', planta: 'baixo', betta: 'risco', kind: 'shrimp', color: '#b5a888',
    obs: 'Ótimo comedor de alga-cabelo. Mais resistente que o Red Cherry, mas só se reproduz em água salobra — não prolifera no aquário doce comum.' },
  { id: 'ancistrus', n: 'Cascudo Ancistrus', sci: 'Ancistrus sp.', adult: 12, zona: 'fundo', bio: 1.4, grupo: 1, temp: [22, 28], ph: [6.0, 7.5], camarao: 'baixo', planta: 'medio', betta: 'ok', kind: 'fish', color: '#5a5a5a',
    obs: 'Precisa de esconderijos (troncos/tubos) e alimentação suplementar noturna (pepino, abobrinha) além de algas. Evite mais de um macho adulto em aquário pequeno.' },
  { id: 'outro',   n: 'Outra espécie', sci: '', adult: 5, zona: 'meia-água', bio: 1.0, grupo: 1, temp: [22, 28], ph: [6.0, 8.0], camarao: 'medio', planta: 'medio', betta: 'atencao', kind: 'fish', color: '#1a7ff0', obs: '' }
];
...
export function newAquarium(over = {}) {
  ...
  return Object.assign({
    ...
    // declaredMature: usuário informou que o aquário já era ciclado ANTES de começar a
    // usar o app (ex.: aquário antigo sendo cadastrado agora). Dispensa o histórico de
    // 3 medições em 0/0 ao longo de 5 dias, mas nunca dispensa amônia/nitrito = 0 hoje
    // — ver canAddFish() e cyclingStatus() em engine.js.
    cycling: { active: true, start: today, phase: 1, done: false, doneAt: null, declaredMature: false, declaredMatureAt: null },
