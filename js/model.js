...
export const SPECIES = [
  ...
  { id: 'danio',   n: 'Danio-zebra', sci: 'Danio rerio', adult: 5, zona: 'meia-água', bio: 0.6, grupo: 6, temp: [18, 24], ph: [6.5, 7.5], camarao: 'baixo', planta: 'baixo', betta: 'atencao',
  ...
  { id: 'molinesia', n: 'Molinésia', sci: 'Poecilia sphenops', adult: 8, zona: 'meia-água', bio: 1.0, grupo: 3, temp: [24, 28], ph: [7.0, 8.5], camarao: 'medio', planta: 'medio', betta: 'atencao',
  ...
  { id: 'cherrybarb', n: 'Barbo-cereja', sci: 'Pethia nigrofasciata', adult: 5, zona: 'meia-água', bio: 0.6, grupo: 6, temp: [22, 26], ph: [6.0, 7.5], camarao: 'baixo', planta: 'baixo', betta: 'atencao',
    obs: 'Pacífico em cardume grande; em grupo pequeno os machos disputam território entre si.' },
  { id: 'lemontetra', n: 'Tetra-limão', sci: 'Hyphessobrycon pulchripinnis', adult: 4.5, zona: 'meia-água', bio: 0.5, grupo: 8, temp: [23, 27], ph: [6.0, 7.0], camarao: 'medio', planta: 'baixo', betta: 'atencao',
    obs: 'Cardume grande realça a cor amarela. Sensível a água velha — TPAs regulares mantêm a cor viva.' },
  { id: 'cardinal', n: 'Tetra-cardinal', sci: 'Paracheirodon axelrodi', adult: 4, zona: 'meia-água', bio: 0.5, grupo: 8, temp: [24, 28], ph: [5.0, 6.5], camarao: 'medio', planta: 'baixo', betta: 'atencao',
    obs: 'Parecido com o Neon-tetra, mas exige água mais quente e ácida; mais sensível a oscilações de qualidade que o Neon.' },
  { id: 'gourami', n: 'Gourami-anão', sci: 'Trichogaster lalius', adult: 8, zona: 'superfície', bio: 1.1, grupo: 1, temp: [24, 28], ph: [6.0, 7.5], camarao: 'medio', planta: 'baixo', betta: 'risco',
  ...
  { id: 'angelfish', n: 'Acará-bandeira', sci: 'Pterophyllum scalare', adult: 15, zona: 'meia-água', bio: 2.2, grupo: 1, temp: [24, 28], ph: [6.0, 7.5], camarao: 'alto', planta: 'baixo', betta: 'risco',
  ...
  { id: 'amano',   n: 'Camarão Amano', sci: 'Caridina multidentata', adult: 5, zona: 'fundo', bio: 0.2, grupo: 6, temp: [20, 27], ph: [6.5, 7.5], camarao: 'self', planta: 'baixo', betta: 'risco',
  ...
  { id: 'ancistrus', n: 'Cascudo Ancistrus', sci: 'Ancistrus sp.', adult: 12, zona: 'fundo', bio: 1.4, grupo: 1, temp: [22, 28], ph: [6.0, 7.5], camarao: 'baixo', planta: 'medio', betta: 'ok',
